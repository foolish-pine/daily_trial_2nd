  ...
  <main class="l-main">
    ...
    <div id="contact" class="p-contact">
      <div class="p-contact__container">
        ...
        <!-- お問い合わせフォーム入力ページここから -->
        <form class="p-contact__form" action="contact/index.php" method="post">
          ...
          <div class="p-contact__form-parts-container">
            ...
            <input class="p-contact__textbox" type="text" id="name" name="name" placeholder="氏名" required />
          </div>
          <div class="p-contact__form-parts-container">
            ...
            <input class="p-contact__textbox" type="text" id="furigana" name="furigana" placeholder="フリガナ" required />
          </div>
          <div class="p-contact__form-parts-container">
            ...
            <input class="p-contact__textbox" type="text" id="email" name="email" placeholder="sample@gmail.com" required />
          </div>
          <div class="p-contact__form-parts-container">
            ...
            <div class="p-contact-radio-button-container">
              <label class="p-contact__radio-label">
                <input class="p-contact__radio" type="radio" id="male" name="sex" value="男性" /> 男性
              </label>
              <label class="p-contact__radio-label">
                <input class="p-contact__radio" type="radio" id="female" name="sex" value="女性" /> 女性
              </label>
            </div>
          </div>
          ...
          <div class="p-contact__agree">
            <label class="p-contact__agree-text" for="agree">
              <input type="checkbox" id="agree" name="agree" value="agree" /> 個人情報保護方針に同意する
            </label>
          </div>
